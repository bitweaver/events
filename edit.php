<?php
/**
 * @version $Header: /cvsroot/bitweaver/_bit_events/edit.php,v 1.17 2008/10/02 16:17:15 wjames5 Exp $
...
if ($gContent->isValid()) {
	$gContent->verifyUserPermission('p_events_edit' );
}
else {
	$gContent->verifyUserPermission('p_events_create');
}
