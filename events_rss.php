<?php
/**
 * @version $Header: /cvsroot/bitweaver/_bit_events/events_rss.php,v 1.1 2006/01/26 00:54:45 bitweaver Exp $
 * @package wiki
...
$rss->title = $gBitSystem->getPreference( 'title_rss_events', $gBitSystem->mPrefs['siteTitle'].' - '.tra( 'Events' ) );
$rss->description = $gBitSystem->getPreference( 'desc_rss_events', $gBitSystem->mPrefs['siteTitle'].' - '.tra( 'RSS Feed' ) );
...
$max_records = $gBitSystem->getPreference( 'max_rss_events', 10 );
$pParamHash['offset'] = 0;
