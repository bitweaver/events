<?php
/**
 * @version $Header: /cvsroot/bitweaver/_bit_events/events_rss.php,v 1.2 2006/03/01 20:16:06 spiderr Exp $
 * @package wiki
...
$rss->title = $gBitSystem->getConfig( 'title_rss_events', $gBitSystem->mPrefs['siteTitle'].' - '.tra( 'Events' ) );
$rss->description = $gBitSystem->getConfig( 'desc_rss_events', $gBitSystem->mPrefs['siteTitle'].' - '.tra( 'RSS Feed' ) );
...
$max_records = $gBitSystem->getConfig( 'max_rss_events', 10 );
$pParamHash['offset'] = 0;
